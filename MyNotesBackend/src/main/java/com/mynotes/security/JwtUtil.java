...
public class JwtUtil {
    ...
    private static final String SECRET_KEY = "e8a3352691faab913fd6138516832ec50bc2f18887bee973ec32955bca84d8cb";
    ...
    // 2. Token Geçerli mi? (Kullanıcı doğru mu ve süresi dolmamış mı?)
    public boolean isTokenValid(String token, UserDetails userDetails) {
        final String username = extractUsername(token);
        return (username.equals(userDetails.getUsername()) && !isTokenExpired(token));
    }

    // 3. Token Üretme (Generate)
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setSubject(userDetails.getUsername()) // Email'i subject yapıyoruz
